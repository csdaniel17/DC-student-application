...
app.controller('CodeController', function($scope, $http, $timeout, $cookies, $location, backend, $sce) {

    // test calling jasmine spec runner
    //$http({
    //   method: 'GET',
    //   url: 'http://localhost:3000/codeTest/jasmine/SpecRunner.html',
    //   headers: {
    //     'Content-Type': 'text/html; charset=UTF-8'
    //   }
    // })

    //http://localhost:3000/codeTest/jasmine/SpecRunner.html
    //http://localhost:3000/codeTest/jasmine/SpecRunner.html?spec=Code%20Challenge%20should%20have%20fullName%20set%20to%20Alan%20Turing

    // $http.get('http://localhost:3000/codeTest/jasmine/SpecRunner.html?')
    // .then(function(response) {
    //   $scope.jasmine = $sce.trustAsHtml(response.data);
